...
public strictfp class ToleranceModifiersTest implements DirectPosition {
    ...
    public void testGeographic() {
        ...
        assertEquals(modifier, modifier, "Object shall be equal to itself.");
        assertEquals("ToleranceModifier.Geographic[λ,φ,…]", modifier.toString(), "toString()");
    ...
    public void testProjection() {
        ...
        assertEquals(modifier, modifier, "Object shall be equal to itself.");
        assertEquals("ToleranceModifier.Projection[λ,φ,…]", modifier.toString(), "toString()");
    ...
    public void testScale() {
        ...
        assertEquals(modifier, modifier, "Object shall be equal to itself.");
        assertEquals("ToleranceModifier.Scale[INVERSE_TRANSFORM:·,×2,…]", modifier.toString(), "toString()");
    ...
    public void testMaximum() {
        ...
        assertEquals(modifier, modifier, "Object shall be equal to itself.");
        assertEquals("ToleranceModifier.Maximum[Projection[λ,φ,…], Relative[…]]", modifier.toString(), "toString()");
    ...
    public void testConcatenate() {
        ...
        assertEquals(modifier, modifier, "Object shall be equal to itself.");
        assertEquals("ToleranceModifier.Concatenate[Geographic[λ,φ,…] → Relative[…]]", modifier.toString(), "toString()");

        modifier.adjust(tolerance, this, CalculationType.INVERSE_TRANSFORM);
        assertArrayEquals(new double[] {3600, 2.42981E-3, 20}, tolerance, 1E-8, "Expected converted and scaled values.");
    }
}
